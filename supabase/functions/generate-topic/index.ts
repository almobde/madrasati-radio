...
- **للنصوص العادية**: شكّل آخر الكلمة فقط (الإعراب) - الفتحة، الضمة، الكسرة، التنوين حسب موقع الكلمة في الجملة
- **للآيات القرآنية فقط**: ضع التشكيل الكامل على جميع حروف الآية (الفتحة، الضمة، الكسرة، السكون، التنوين، الشدة)
- اهتم بدقة الإعراب في أواخر الكلمات (رفع، نصب، جر، جزم)
- لا تشكل الكلمات بالكامل إلا في الآيات القرآنية

**الآيات القرآنية والأحاديث النبوية - إرشادات مهمة:**
- **تجنب التكرار**: لا تستخدم الآيات والأحاديث المشهورة والمتكررة في كل موضوع
- **ابحث عن الجديد**: استخدم آيات وأحاديث متنوعة وأقل شيوعاً تتناسب مع الموضوع
- **للمواضيع الدينية المباشرة**: استخدم آيات وأحاديث مرتبطة مباشرة بالموضوع
- **للمواضيع التقنية أو الدنيوية أو الرياضية** (مثل: الذكاء الاصطناعي، الرياضة، التكنولوجيا، الصحة):
  * **يجب استخدام** آيات وأحاديث عامة عن العلم والتعلم والسعي والاجتهاد
  * أمثلة للآيات العامة: آيات عن طلب العلم، التفكر، التدبر، إعمار الأرض، تسخير الكون
  * **تجنب استخدام** الأحاديث التالية لأنها متكررة في المواضيع السابقة:
    - "مَنْ سَلَكَ طَرِيقًا يَلْتَمِسُ فِيهِ عِلْمًا سَهَّلَ اللَّهُ لَهُ بِهِ طَرِيقًا إِلَى الْجَنَّةِ"
    - "إِنَّمَا الْأَعْمَالُ بِالنِّيَّاتِ"
    - "إِنَّ اللَّهَ يُحِبُّ إِذَا عَمِلَ أَحَدُكُمْ عَمَلًا أَنْ يُتْقِنَهُ"
    - "خَيْرُ النَّاسِ أَنْفَعُهُمْ لِلنَّاسِ"
  * **ابحث عن أحاديث بديلة** عن الاجتهاد، السعي، التعلم، التفكر، الإبداع، الأمانة، الصبر، إتقان العمل
- **تجنب الآيات المتكررة**: لا تستخدم "اقْرَأْ بِاسْمِ رَبِّكَ الَّذِي خَلَقَ" في كل موضوع، ابحث عن آيات أخرى مناسبة

**الأحاديث النبوية الشريفة - شروط إلزامية وحاسمة:**
- **ممنوع منعاً باتاً** ترك نص الحديث ناقصاً أو فارغاً!
- **يجب** كتابة الحديث بالنص الكامل من أوله إلى آخره، وليس مجرد ذكر الراوي
- **صيغة إلزامية:** "عَنْ [اسم الراوي] رَضِيَ اللَّهُ عَنْهُ قَالَ: قَالَ رَسُولُ اللَّهِ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ: [نص الحديث كاملاً من أوله لآخره بدون اختصار]"
- **مثال صحيح كامل:** "عَنْ أَبِي هُرَيْرَةَ رَضِيَ اللَّهُ عَنْهُ قَالَ: قَالَ رَسُولُ اللَّهِ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ: مَنْ سَلَكَ طَرِيقًا يَلْتَمِسُ فِيهِ عِلْمًا سَهَّلَ اللَّهُ لَهُ بِهِ طَرِيقًا إِلَى الْجَنَّةِ"
- **خطأ شائع يجب تجنبه:** لا تكتب فقط "قَالَ رَسُولُ اللَّهِ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ: ..." ثم تتوقف - يجب كتابة النص كاملاً
- اذكر المصدر في النهاية: "رَوَاهُ البُخَارِيّ" أو "رَوَاهُ مُسْلِم" أو "مُتَّفَقٌ عَلَيْه"
- **تحذير نهائي:** الحديث بدون نص كامل = خطأ فادح غير مقبول
...
${contentLengthGuidelines}`;
    ...
    if (selectedSections.hadiths) {
      ...
      sections.push(`${sectionNumber}. **${hadithsCount} نبوية صحيحة كاملة** - متطلبات حاسمة وإلزامية:
   * **صيغة إلزامية:** اسم الراوي + "قَالَ: قَالَ رَسُولُ اللَّهِ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ:" + [نص الحديث الكامل بدون أي اختصار] + المصدر
   * **مثال صحيح:** "عَنْ أَبِي هُرَيْرَةَ رَضِيَ اللَّهُ عَنْهُ قَالَ: قَالَ رَسُولُ اللَّهِ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ: مَنْ سَلَكَ طَرِيقًا يَلْتَمِسُ فِيهِ عِلْمًا سَهَّلَ اللَّهُ لَهُ بِهِ طَرِيقًا إِلَى الْجَنَّةِ. رَوَاهُ مُسْلِم"
   * **خطأ فادح:** كتابة "قَالَ رَسُولُ اللَّهِ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ: ..." بدون نص الحديث = غير مقبول نهائياً
   * **تحذير:** يجب كتابة النص الكامل من البداية للنهاية بدون نقاط حذف (...)
   * استخدم أحاديث متنوعة وغير متكررة - تجنب الأحاديث المشهورة جداً
   * للمواضيع التقنية/الدنيوية: ابحث عن أحاديث بديلة عن العلم والإتقان والاجتهاد والصبر والأمانة`);
      sectionNumber++;
    }
...
- ${languageGuidelines}
- ${contentLengthGuidelines}
- **التشكيل**: شكّل آخر الكلمات فقط (الإعراب) - الفتحة، الضمة، الكسرة، التنوين حسب موقع الكلمة في الجملة
- **للآيات القرآنية فقط**: ضع التشكيل الكامل على جميع حروف الآية
- **اهتم بدقة الإعراب** في أواخر الكلمات (رفع، نصب، جر، جزم)
...
- **إذا كان الموضوع تقنياً أو دنيوياً (مثل الذكاء الاصطناعي، الرياضة...)، استخدم آيات وأحاديث عامة عن العلم والاجتهاد**
- **⚠️ الأحاديث - تحذير شديد الأهمية:** 
  * يجب كتابة نص الحديث كاملاً من أوله لآخره بدون أي اختصار أو نقاط حذف
  * ممنوع كتابة "قَالَ رَسُولُ اللَّهِ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ: ..." والتوقف
  * يجب كتابة النص الكامل: اسم الراوي + "قَالَ: قَالَ رَسُولُ اللَّهِ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ:" + نص الحديث الكامل + المصدر
- ${contentLength === 'short' 
...
أرجع الناتج كـ JSON مباشرة:
{
  ...
  "radioEnding": "نهاية الإذاعة..."
    ...
    try {
      ...
      // Validate hadiths to ensure they have complete text
      if (topicContent.hadiths && Array.isArray(topicContent.hadiths)) {
        for (let i = 0; i < topicContent.hadiths.length; i++) {
          const hadith = topicContent.hadiths[i];
          
          // Check if hadith text is missing or too short
          if (!hadith.text || hadith.text.length < 50) {
            console.error(`Hadith ${i + 1} has incomplete text:`, hadith.text);
            return new Response(JSON.stringify({ 
              error: "الأحاديث المُولّدة غير مكتملة. الرجاء المحاولة مرة أخرى." 
            }), {
              status: 500,
              headers: { ...corsHeaders, "Content-Type": "application/json" },
            });
          ...
          // Check if text contains ellipsis or is cut off
          if (hadith.text.includes('...') || hadith.text.includes('…')) {
            console.error(`Hadith ${i + 1} contains ellipsis:`, hadith.text);
            return new Response(JSON.stringify({ 
              error: "الأحاديث المُولّدة تحتوي على نص ناقص. الرجاء المحاولة مرة أخرى." 
            }), {
              status: 500,
              headers: { ...corsHeaders, "Content-Type": "application/json" },
            });
          ...
          // Check if it's just "قَالَ رَسُولُ اللَّهِ" without actual hadith
          const hasActualContent = hadith.text.includes('قَالَ رَسُولُ اللَّهِ') && 
                                   hadith.text.length > 100; // Should be longer if it has actual content
          
          if (!hasActualContent) {
            console.error(`Hadith ${i + 1} appears incomplete:`, hadith.text);
            return new Response(JSON.stringify({ 
              error: "الأحاديث المُولّدة غير كاملة. الرجاء المحاولة مرة أخرى." 
            }), {
              status: 500,
              headers: { ...corsHeaders, "Content-Type": "application/json" },
            });
        ...
        console.log("All hadiths validated successfully");
      }
    } catch (parseError) {
