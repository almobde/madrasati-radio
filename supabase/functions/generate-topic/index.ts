...
**الأحاديث النبوية الشريفة - شروط إلزامية:**
- **يجب** أن يكون الحديث كاملاً بالنص الكامل، ليس فقط الراوي!
- ابدأ كل حديث باسم الراوي ثم النص الكامل للحديث
- مثال صحيح: "عَنْ أَبِي هُرَيْرَةَ رَضِيَ اللَّهُ عَنْهُ قَالَ: قَالَ رَسُولُ اللَّهِ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ: مَنْ سَلَكَ طَرِيقًا يَلْتَمِسُ فِيهِ عِلْمًا سَهَّلَ اللَّهُ لَهُ بِهِ طَرِيقًا إِلَى الْجَنَّةِ"
- **لا تترك** نص الحديث فارغاً أو ناقصاً أبداً
- اذكر المصدر: "رَوَاهُ البُخَارِيّ" أو "رَوَاهُ مُسْلِم" أو "مُتَّفَقٌ عَلَيْه"
...
${contentLengthGuidelines}`;
    ...
    if (selectedSections.hadiths) {
      ...
      sections.push(`${sectionNumber}. **${hadithsCount} نبوية صحيحة كاملة** - يجب أن تحتوي على:
   * اسم الراوي (عَنْ فلان رَضِيَ اللَّهُ عَنْهُ)
   * نص الحديث الكامل (لا يجوز تركه فارغاً)
   * المصدر (رَوَاهُ البُخَارِيّ / مُسْلِم)
   * **مهم**: استخدم أحاديث متنوعة وغير متكررة - تجنب الأحاديث المشهورة جداً
...
- **الأحاديث يجب أن تكون كاملة بالنص، ليس فقط اسم الراوي!**
- ${contentLength === 'short' 
